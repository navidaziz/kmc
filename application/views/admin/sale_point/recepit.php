...
<table class="table1 table1-bordered1" style="width: 100% !important;">
    <thead>
        <tr>
            <th colspan="5">
                <h4 style="text-align: center;">Kashghar Medical Center Chitral</h4>
                <h6 style="text-align: center; font-size: 11px;">Dewan Trade Center Airport Road Kuprisht Chitral
